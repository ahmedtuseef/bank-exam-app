    ...
    questions: [
      {
        ...
        answer: 0,
        sol: "CPU = Central Processing Unit",
      },
      {
        q: "RAM stands for?",
        options: [
      ...
      },
      {
        ...
        answer: 0,
        sol: "Monitor shows output",
      },
      {
        q: "1 Byte = how many bits?",
        options: ["8", "4", "16", "2"],
        answer: 0,
        sol: "1 Byte = 8 bits",
      },
      ...
      {
        q: "Shortcut key to copy?",
        options: ["Ctrl + C", "Ctrl + V", "Ctrl + X", "Ctrl + Z"],
        answer: 0,
        sol: "Ctrl+C = copy",
      },
      {
        q: "Shortcut key to paste?",
        options: ["Ctrl + V", "Ctrl + C", "Ctrl + P", "Ctrl + B"],
        answer: 0,
        sol: "Ctrl+V = paste",
      },
      {
      ...
      },
      {
        ...
        answer: 0,
        sol: "Hard Disk = permanent storage",
      },
      {
        q: "The 'brain' of the computer is?",
        options: ["CPU", "Monitor", "RAM", "Keyboard"],
        answer: 0,
        sol: "CPU is the brain",
      },
      {
        q: "Which key deletes the character to the left?",
        options: ["Backspace", "Delete", "Enter", "Shift"],
        answer: 0,
        sol: "Backspace deletes left",
      },
    ],
  },
    ...
    questions: [
      {
        ...
        answer: 0,
        sol: "RBI = Reserve Bank of India",
      },
      {
        q: "In which year was RBI established?",
        options: ["1935", "1947", "1950", "1969"],
        answer: 0,
        sol: "RBI established in 1935",
      },
      {
        q: "Headquarters of RBI is in?",
      ...
      },
      {
        ...
        answer: 0,
        sol: "NEFT = National Electronic Funds Transfer",
      },
      {
        q: "Full form of ATM?",
        options: [
        ...
        answer: 0,
        sol: "ATM = Automated Teller Machine",
      },
      {
        q: "Full form of IFSC?",
        options: [
        ...
        answer: 0,
        sol: "IFSC = Indian Financial System Code",
      },
      {
        q: "Full form of KYC?",
        options: [
        ...
        answer: 0,
        sol: "KYC = Know Your Customer",
      },
      {
        q: "Who issues currency notes in India?",
        options: ["RBI", "SBI", "Government", "Finance Ministry"],
        answer: 0,
        sol: "RBI issues currency (except ₹1 note)",
      },
      {
        q: "Full form of UPI?",
        options: [
        ...
        answer: 0,
        sol: "UPI = Unified Payments Interface",
      },
      {
        q: "Full form of NPA?",
        options: [
      ...
      },
      {
        ...
        options: [
          ...
          "Rapid Transfer Gross Settlement",
          "Real Transfer Gross System",
        ],
        answer: 0,
        sol: "RTGS = Real Time Gross Settlement",
      },
      {
        q: "Full form of MICR?",
        options: [
          ...
          "Money Ink Character Recognition",
          "Magnetic Integrated Character Reader",
        ],
        answer: 0,
        sol: "MICR = Magnetic Ink Character Recognition",
      },
      {
        q: "Full form of PIN (in ATM)?",
        options: [
        ...
        answer: 0,
        sol: "PIN = Personal Identification Number",
      },
    ],
  },
};
